...
\noindent\textbf{\bf Remarques sur la semaine du 30 mars au 3 avril 2020}
\begin{itemize}
\item Le programme de colle imaginaire est celui-ci : tout le chapitre XIX sur les familles de vecteurs et les applications linéaires.
...
\begin{itemize}
\item Cours : Dimension finie, partie 3.
\item Exercices : feuille n° 21, ex. 4 à 7.
...
\begin{itemize}
\item DM16 à rendre.
\item Cours : Dimension finie, partie 2.
...
\begin{itemize}
\item Cours : Intégration : Dimension finie, fin de la partie 1.
...
\begin{itemize}
\item Cours : \textbf{Chapitre XXII :} Dimension finie : Partie 1, sections 1.1 à 1.3.
...
\item Faire l'\og interrogation \fg n° 16 : \vspace{.4cm}
\end{itemize}
